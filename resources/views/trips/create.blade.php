            ...
            <form method="POST" action="{{ route('trips.store') }}" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" id="trip_date" name="trip_date" type="date" value="{{ old('trip_date') }}" @if ($restrictPastTrips) min="{{ $todayDate }}" @endif required>
                        @error('trip_date') <div class="text-danger small">{{ $message }}</div> @enderror
                    </div>
                    <div class="col-md-6">
                        <label class="form-label" for="trip_time">Trip Time</label>
                        <input class="form-control" id="trip_time" name="trip_time" type="time" value="{{ old('trip_time') }}">
