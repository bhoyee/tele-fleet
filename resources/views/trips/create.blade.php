<x-admin-layout>
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-1">New Trip Request</h1>
            <p class="text-muted mb-0">Submit a trip request for approval.</p>
        </div>
            ...
            <form method="POST" action="{{ route('trips.store') }}">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" id="trip_date" name="trip_date" type="date" value="{{ old('trip_date') }}" required>
                        @error('trip_date') <div class="text-danger small">{{ $message }}</div> @enderror
                    </div>
                    <div class="col-md-6">
                        <label class="form-label" for="purpose">Purpose</label>
                        <input class="form-control" id="purpose" name="purpose" value="{{ old('purpose') }}" required>
                        @error('purpose') <div class="text-danger small">{{ $message }}</div> @enderror
                    </div>
                    <div class="col-md-6">
                        <label class="form-label" for="destination">Destination</label>
                        <input class="form-control" id="destination" name="destination" value="{{ old('destination') }}" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <input class="form-control" id="estimated_distance_km" name="estimated_distance_km" type="number" step="0.01" value="{{ old('estimated_distance_km') }}">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label" for="number_of_passengers">Passengers</label>
                        <input class="form-control" id="number_of_passengers" name="number_of_passengers" type="number" min="1" value="{{ old('number_of_passengers', 1) }}">
                    </div>
                    <div class="col-md-12">
