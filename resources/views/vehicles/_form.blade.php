...
<div class="row g-3">
    ...
    <div class="col-md-4">
        <label class="form-label" for="last_maintenance_mileage">Last Maintenance Mileage</label>
        <input class="form-control" id="last_maintenance_mileage" name="last_maintenance_mileage" type="number"
               value="{{ old('last_maintenance_mileage', $vehicle?->last_maintenance_mileage ?? 0) }}" required>
        @error('last_maintenance_mileage') <div class="text-danger small">{{ $message }}</div> @enderror
    </div>
    <div class="col-md-4">
