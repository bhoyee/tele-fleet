<x-admin-layout>
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-1">{{ $branchName }} Report</h1>
            <p class="text-muted mb-0">Branch-wide trip requests (branch admin + branch head).</p>
        </div>
        <div class="d-flex gap-2">
            <a class="btn btn-outline-primary" href="{{ route('reports.branch.excel', request()->query()) }}" data-download>Export Excel (CSV)</a>
            <a class="btn btn-outline-dark" href="{{ route('reports.branch.pdf', request()->query()) }}" data-download>Export PDF</a>
        </div>
    </div>
        ...
        <div class="card-body">
            <form method="GET" class="row g-3 align-items-end">
                ...
                <div class="col-12 d-flex gap-2">
                    ...
                    <a class="btn btn-outline-secondary w-100" href="{{ route('reports.branch') }}" data-loading>Reset</a>
                </div>
            </form>
        </div>
    </div>
